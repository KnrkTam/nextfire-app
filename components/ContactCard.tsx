...
export default function ContactCard({}) {
    ...
    return (
        <>
        <div className="card card-info lg:w-1/4 shadow-xl flex items-center flex-col" > 
            ...
            <span className="flex gap-2 mb-2">
                <Link href="https://github.com/knrktam">
                    <a target="_blank">
                        <GitHubIcon className="w-8 h-8 transition transform cursor-pointer text-blueGray-400 hover:text-gray-600 hover:bg-white-600 hover:scale-110 duration-600" />
                    </a>
                </Link>  
                <Link href="https://www.linkedin.com/in/kenrick-tam-39625915b/">
                    <a target="_blank">
                        <LinkedInIcon className="w-8 h-8 transition transform cursor-pointer text-blueGray-400 hover:text-blue-600 hover:scale-110 duration-600" />
                    </a>
                </Link>
            
                <a href="" onClick={contactMe}>
                    <EmailIcon className="w-8 h-8 transition transform cursor-pointer text-blueGray-400 hover:text-orange-600 hover:scale-110 duration-600" />

                </a>
                <Link href="https://wa.me/14379748229?text=Hello World!">
                  <a target="_blank">
                    <WhatsAppIcon className="w-8 h-8 transition transform cursor-pointer text-blueGray-400 hover:text-green-600 hover:scale-110 duration-600" />
                  </a>
                </Link>
            </span>
