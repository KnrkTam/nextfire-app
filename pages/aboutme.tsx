...
item-center justify-center'>
                ...
                <div className='grid lg:grid-cols-1 ml:grid-cols-1 flex'>
            ...
            <div className='text-black mt-5 grid lg:grid-cols-2 ml:grid-cols-1 gap-4 lg:gap-6'>
  ...
  <path d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z"/>
              ...
              <div className='card-item'><h3 className='font-bold flex'>Exercise<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
